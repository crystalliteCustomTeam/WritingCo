                ...
                <Row>
                    <Col>
                        ...
                        <ul className="CustomUl">
                            <li><CheckedIcon />“Financial Information” means specific Personal Information of a financial nature such as your credit card number.</li>
                            <li><CheckedIcon /> “Information” means any Information collected and includes: “Personal Information”, “Financial Information”, “Web Analytical Information” or any other Information collected from you through our Site(s).</li>
                            <li><CheckedIcon /> “Marketing Information” means your Web Analytical Information and your Personal Information such as your name, address, e-mail address and telephone number that the Organization collects uses and discloses for the marketing and promotional purposes as disclosed in this Privacy Policy.</li>
                            <li><CheckedIcon />“Personal Information” means Information that may be used, alone or in combination, to identify a specific individual and includes Financial Information.</li>
                            <li><CheckedIcon /> “Site” or “Sites” means the Organization’s website located at www.book writing.us as any other Organization-controlled or authorized Sites (including, without limitation, any Business Associate sites), regardless of domain name or IP address.</li>
                            <li><CheckedIcon /> “Social Network”, means various Internet communication technologies provided on Sites that facilitate conversation and interaction between people online and includes, but is not limited to, blogs, discussion forums, wikis, chat sessions, newsgroups, etc.</li>
                            <li><CheckedIcon /> “Social Network Content” (or “SNC”) means the user-generated content you consent to share via a Social Network and includes, but is not limited to, Personal Information, including digital sounds and pictures that you upload to a Social Network. It also includes your Personal Information that may be displayed on other users’ Social Network pages.</li>
                            <li><CheckedIcon /> “Organization”, “we”, “us”, and “our” refer to the book writing.</li>
                            <li><CheckedIcon /> “Unrelated Entities” means third parties that are not Educational Partners and who are not providing services to book writing. as Business Associates.</li>
                            <li><CheckedIcon /> “Web Analytical Information” means internet generated Information we collect when you visit our Sites. This Information may be linked to marketing and Personal Information. When linked with other Information identifying you personally, either alone or in combination with other Information, then such Information also will be considered Personal Information.</li>
                        </ul>   <br />
                        ...
                        <ul className="CustomUl">
                            <li><CheckedIcon />IP address</li>
                            <li><CheckedIcon />Collection Date</li>
                            <li><CheckedIcon />Publisher Name</li>
                            <li><CheckedIcon />Connection Speed</li>
                            <li><CheckedIcon />Day of Week Time of Day (hour)</li>
                            <li><CheckedIcon />Language settings</li>
                            <li><CheckedIcon />Country, State, DMA, City (relating to IP address, if available)</li>
                            <li><CheckedIcon />Domain (.com, .net, .mil, .org, .edu, etc.)</li>
                        </ul>
                        <br />
                        ...
                        <ul className="CustomUl">
                            <li><CheckedIcon />to provide requested products and services</li>
                            <li><CheckedIcon />to respond to your inquiries</li>
                            <li><CheckedIcon />to administer promotions to which you have indicated an interest</li>
                            <li><CheckedIcon />for our internal marketing purposes, which includes, but is not limited to, sending you material about products, services, updates, etc. that we think may be of interest to you</li>
                            <li><CheckedIcon />for fostering communication and collaboration among members of the Organization community through Social Networks</li>
                            <li><CheckedIcon />for sharing with our Partners who may contact you with respect to their services;</li>
                            <li><CheckedIcon />for sharing with our Partners or Business Associates who are performing services on our behalf</li>
                            <li><CheckedIcon />to analyze how Sites and services are being accessed and used;</li>
                            <li><CheckedIcon />to improve Site and service performance and delivery</li>
                            <li><CheckedIcon />to analyze academic and learning outcomes and preferences</li>
                            <li><CheckedIcon />to analyze risk and business results</li>
                            <li><CheckedIcon />to obtain payment for services that we provide to you</li>
                            <li><CheckedIcon />to maintain business records for reasonable periods</li>
                        </ul>   <br />
                        ...
                        <ul className="CustomUl">
                            <li><CheckedIcon />Toll-Free number: 866-600-0036</li>
                            <li><CheckedIcon />E-mail: info@bookwriting.us</li>
                        </ul>
                    </Col>
                </Row>
            </Container>
