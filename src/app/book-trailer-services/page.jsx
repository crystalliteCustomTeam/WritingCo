...
import { InnerServicesData, ServicesData, BannerData, ProcessData, BestSellerData, QuoteData } from "@/src/app/book-trailer-services/data/data";
...
export default function Page() {
    return (
        <>
            ...
            <Clients />
            <ServicesForm title="Hit play on your book’s success" txt="Get a Free Quote" />
