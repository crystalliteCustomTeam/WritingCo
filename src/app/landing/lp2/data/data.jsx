...
export const ContentBox3 = {
    title: (<>We Print According to Your Needs</>),
    txt: (<><p>Why print more than you need? Our Print-On-Demand publishing services ensure your book is printed only when ordered, eliminating unnecessary costs and storage concerns. Get high-quality copies delivered to readers without the hassle of bulk printing.</p></>),
    img: IMG03.src,
    contentPoints: [
        "Flexible Printing",
        "Global Availability",
