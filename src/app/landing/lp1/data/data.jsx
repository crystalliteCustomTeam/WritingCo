...
export const ServicesData = {
    ...
    ServicesItem: [
        {
            title: "Book Writing",
            txt: "Know this: not many authors secure any deal with the publishers. But at Book Writ Know this: not many authors secure any deal with the Know this: not many authors secure any deal with the publishers.",
        },
        {
            title: "Book Editing",
            txt: "Know this: not many authors secure any deal with the publishers. But at Book Writ Know this: not many authors secure any deal with the Know this: not many authors secure any deal with the publishers.",
...
export const ContentBox1 = {
    ...
    contentPoints: [
        "Oftentimes, we find",
        "Oftentimes,",
        "Some thoughts to others.",
        "But most of unexplored."
    ]
}
